package com.miguelfaria.cursomc;
...
import com.miguelfaria.cursomc.domain.Endereco;
import com.miguelfaria.cursomc.domain.Estado;
import com.miguelfaria.cursomc.domain.ItemPedido;
import com.miguelfaria.cursomc.domain.Pagamento;
import com.miguelfaria.cursomc.domain.PagamentoComBoleto;
import com.miguelfaria.cursomc.domain.PagamentoComCartao;
...
import com.miguelfaria.cursomc.domain.enums.TipoCliente;
import com.miguelfaria.cursomc.repositories.CategoriaRepository;
import com.miguelfaria.cursomc.repositories.CidadeRepository;
import com.miguelfaria.cursomc.repositories.ClienteRepository;
import com.miguelfaria.cursomc.repositories.EnderecoRepository;
import com.miguelfaria.cursomc.repositories.EstadoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Produto p8 = new Produto(null, "Roçadeira", 300.00);
		...
		Cliente cli1 = new Cliente(null,"Maria Silva", "maria@gmail.com", "25627898012",TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("26269877","976540012"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 300", "Jardim", "08111330", cli1, c1);
		Endereco e2 = new Endereco(null, "Rua Avenida Matos", "105", "Sala 800", "Centro", "08112000", cli1, c2);
